...
(function(f) {
    ...
    i.treemap = u(i.scatter, m({
        ...
        getTree: function() {
            ...
            q(this.nodeMap[this.rootNode].children,
                function(a) {
                    var b = !1;
                    k(a, function(a) {
                        a.visible = !0;
        ...
        algorithmCalcPoints: function(a, b, c, d) {
            ...
            k(c.elArr, function(a) {
                if (b || o < p) c.direction === 0 ? (e = l.x, h = l.y, g = j, f = a / g) : (e = l.x, h = l.y, f = s, g = a / f),
                    d.push({
                        x: e,
                        y: h,
                        width: g,
        ...
        drawPoints: function() {
            ...
            a.options.allowDrillToNode && k(b, function(b) {
                var d;
                if (b.graphic) d =
                    b.drillId = a.options.interactByLeaf ? a.drillToByLeaf(b) : a.drillToByGroup(b), b.graphic.css({
